...
export function Hero() {
  ...
  return (
      ...
      <div className="relative flex h-[85vh] min-h-[560px] w-full cursor-none items-center justify-center overflow-hidden rounded-3xl bg-secondary">
        <AgentCursor />
        ...
        {/* Bottom blur/fade — soft dissolve at the base of the rounded card */}
        <div className="absolute inset-x-0 bottom-0 h-32 bg-linear-to-b from-transparent to-black/40 backdrop-blur-sm" />
